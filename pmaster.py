...
for classe in clascode:
    ...
    clascont[classe] = multisplit(clascont[classe],"<title>","</title>","<h1>","</h1>","<!--BEFORE-->","<!--VFIN-->")
    clascont[classe] = ["<title>"+clascont[classe][1]+"</title>","<h1>"+clascont[classe][3]+"</h1>","<!--BEFORE-->"+clascont[classe][5]+"<!--VFIN-->"]
